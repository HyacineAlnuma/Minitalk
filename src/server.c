...
/*   Updated: 2024/12/25 18:05:20 by halnuma          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	c = 00000101;
	i = 3;
	donc on va checker le 4e bit en partant de la gauche. 
	...
	si signal == SIGUSR1
		...
		-> Pour le premier bit (tjr en partant de la gauche) c[0] = 1 et
		...
		-> Si c[3] avait été un 1 il le serait rester car 1 | 1 = 1;
		-> Le reste bouge pas
	si signal == SIGUSR2
		-> On veut que ce bit reste un 0, donc on touche a rien, décrémente i
		   et passe au prochain.
	Quand i = -1 c'est qu'on a traité 8 bits, donc un char, on le print puis on
